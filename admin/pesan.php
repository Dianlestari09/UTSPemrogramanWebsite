										...
										<?php while ($pesan = $qry->fetch_assoc()) { ?>
											<?php if ($pesan['status'] == "belum") { ?>
												<tr>
													...
													<td align="center">
														<a href="lihat-pesan.php?id=<?= $pesan['id'] ?>" class="btn btn-sm btn-primary">
															<i class="fa fa-eye"></i>
														</a>
														<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" href="hapus-pesan.php?id=<?= $pesan['id'] ?>" class="btn btn-danger btn-sm">
